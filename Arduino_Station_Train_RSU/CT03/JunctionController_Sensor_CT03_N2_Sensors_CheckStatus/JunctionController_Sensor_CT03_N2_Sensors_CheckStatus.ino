...
struct DirectionInterface directionList[8];

struct StationAndCarInterface stationList[8];
...
void setupDirectionList(){
  directionList[0].target1 = "B04-A";
  directionList[0].target2 = "B05-A";

  directionList[1].target1 = "B04-B";
  directionList[1].target2 = "B05-B";

  directionList[2].target1 = "B05-A";
  directionList[2].target2 = "B11-A";

  directionList[3].target1 = "B05-A";
  directionList[3].target2 = "B11-C";

  directionList[4].target1 = "B05-B";
  directionList[4].target2 = "B11-B";

  directionList[5].target1 = "B05-B";
  directionList[5].target2 = "B11-D";

  directionList[6].target1 = "B09-A";
  directionList[6].target2 = "B11-C";

  directionList[7].target1 = "B09-B";
  directionList[7].target2 = "B11-D";
...
void setupStationList(){
  stationList[0].stationID = "B05-A";
  stationList[0].carID = "";
  stationList[0].lastCarID = "";

  stationList[1].stationID = "B05-B";
  stationList[1].carID = "";
  stationList[1].lastCarID = "";

  stationList[2].stationID = "B11-A";
  stationList[2].carID = "";
  stationList[2].lastCarID = "";

  stationList[3].stationID = "B11-B";
  stationList[3].carID = "";
  stationList[3].lastCarID = "";

  stationList[4].stationID = "B11-C";
  stationList[4].carID = "";
  stationList[4].lastCarID = "";

  stationList[5].stationID = "B11-D";
  stationList[5].carID = "";
  stationList[5].lastCarID = "";

  stationList[6].stationID = "B09-A";
  stationList[6].carID = "";
  stationList[6].lastCarID = "";

  stationList[7].stationID = "B09-B";
  stationList[7].carID = "";
  stationList[7].lastCarID = "";
...
void registerControl(){
  webSocket.emit("registerControl", "{\"name\":\"CT03_02\"}");
}
//----
