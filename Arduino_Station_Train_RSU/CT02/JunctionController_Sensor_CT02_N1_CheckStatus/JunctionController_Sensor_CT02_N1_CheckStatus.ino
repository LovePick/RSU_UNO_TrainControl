...
struct DirectionInterface directionList[4];
...
void setupDirectionList(){
  directionList[0].target1 = "B02-A";
  directionList[0].target2 = "B03-A";

  directionList[1].target1 = "B02-B";
  directionList[1].target2 = "B03-B";

  directionList[2].target1 = "B03-A";
  directionList[2].target2 = "B04-A";

  directionList[3].target1 = "B03-B";
  directionList[3].target2 = "B04-B";
...
void setupStationList(){
  ...
  stationList[0].stationID = "B02-A";
  stationList[0].carID = "";
  stationList[0].lastCarID = "";

  stationList[1].stationID = "B02-B";
  stationList[1].carID = "";
  stationList[1].lastCarID = "";
 
  stationList[2].stationID = "B03-A";
  stationList[2].carID = "";
  stationList[2].lastCarID = "";

  stationList[3].stationID = "B03-B";
  stationList[3].carID = "";
  stationList[3].lastCarID = "";

  stationList[4].stationID = "B04-A";
  stationList[4].carID = "";
  stationList[4].lastCarID = "";

  stationList[5].stationID = "B04-B";
  stationList[5].carID = "";
...
void registerControl(){
  webSocket.emit("registerControl", "{\"name\":\"CT02_01\"}");
}
//----
