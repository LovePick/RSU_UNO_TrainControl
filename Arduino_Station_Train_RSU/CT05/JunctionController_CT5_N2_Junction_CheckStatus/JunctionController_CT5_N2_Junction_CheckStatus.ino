...
void setupDirectionList(){
  directionList[0].target1 = "TB03";
  directionList[0].target2 = "B15-A";

  directionList[1].target1 = "TB03";
  directionList[1].target2 = "B15-B";

  directionList[2].target1 = "TB04";
  directionList[2].target2 = "B15-A";

  directionList[3].target1 = "TB04";
  directionList[3].target2 = "B15-B";

  directionList[4].target1 = "B15-A";
  directionList[4].target2 = "B9-A";

  directionList[5].target1 = "B15-B";
  directionList[5].target2 = "B9-B";
...
void setupStationList(){
  stationList[0].stationID = "TB03";
  stationList[0].carID = "";
  stationList[0].lastCarID = "";

  stationList[1].stationID = "TB04";
  stationList[1].carID = "";
  stationList[1].lastCarID = "";

  stationList[2].stationID = "B15-A";
  stationList[2].carID = "";
  stationList[2].lastCarID = "";

  stationList[3].stationID = "B15-B";
  stationList[3].carID = "";
...
void registerControl(){
  webSocket.emit("registerControl", "{\"name\":\"CT05_02\"}");
}
//----
