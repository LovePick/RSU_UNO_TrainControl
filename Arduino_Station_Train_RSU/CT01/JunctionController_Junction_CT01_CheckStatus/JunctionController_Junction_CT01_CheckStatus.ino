...
#define IR_sensor1Pin D3 
#define IR_sensor2Pin D5 
#define IR_sensor3Pin D6 
#define IR_sensor4Pin D7
#define IR_sensor5Pin D8
...
void registerControl(){
  webSocket.emit("registerControl", "{\"name\":\"CT01_02\"}");
}
//----
