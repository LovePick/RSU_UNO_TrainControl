...
#define IR_sensor7Pin D8
#define IR_sensor8Pin D9  
...
int IR_sensor7_Value;
int IR_sensor8_Value;
...
struct DirectionInterface directionList[14];

struct StationAndCarInterface stationList[7];
...
void setupDirectionList(){
  directionList[0].target1 = "D01";
  directionList[0].target2 = "B02-A";

  directionList[1].target1 = "D01";
  directionList[1].target2 = "B02-B";

  directionList[2].target1 = "D02";
  directionList[2].target2 = "B02-A";

  directionList[3].target1 = "D02";
  directionList[3].target2 = "B02-B";

  directionList[4].target1 = "D03";
  directionList[4].target2 = "B02-A";

  directionList[5].target1 = "D03";
  directionList[5].target2 = "B02-B";

  directionList[6].target1 = "D04";
  directionList[6].target2 = "B02-A";

  directionList[7].target1 = "D04";
  directionList[7].target2 = "B02-B";

  directionList[8].target1 = "D05";
  directionList[8].target2 = "B02-A";

  directionList[9].target1 = "D05";
  directionList[9].target2 = "B02-B";

  directionList[10].target1 = "D06";
  directionList[10].target2 = "B02-A";

  directionList[11].target1 = "D06";
  directionList[11].target2 = "B02-B";

  directionList[12].target1 = "D07";
  directionList[12].target2 = "B02-A";

  directionList[13].target1 = "D07";
  directionList[13].target2 = "B02-B";
...
void setupStationList(){
  stationList[0].stationID = "D01";
  stationList[0].carID = "";
  stationList[0].lastCarID = "";

  stationList[1].stationID = "D02";
  stationList[1].carID = "";
  stationList[1].lastCarID = "";

  stationList[2].stationID = "D03";
  stationList[2].carID = "";
  stationList[2].lastCarID = "";

  stationList[3].stationID = "D04";
  stationList[3].carID = "";
  stationList[3].lastCarID = "";

  stationList[4].stationID = "D05";
  stationList[4].carID = "";
  stationList[4].lastCarID = "";

  stationList[5].stationID = "D06";
  stationList[5].carID = "";
  stationList[5].lastCarID = "";

  stationList[6].stationID = "D07";
  stationList[6].carID = "";
  stationList[6].lastCarID = "";
...
void setup() {
  ...
  pinMode(IR_sensor7Pin, INPUT);
  pinMode(IR_sensor8Pin, INPUT);
...
void registerControl(){
  webSocket.emit("registerControl", "{\"name\":\"CT01_01\"}");
}
//----
...
void testCarArrivedWith(){


  char *body = "{\"arduino\":\"test\"}";
   webSocket.emit("arrived", body);
   Serial.write("testCarArrivedWith");
