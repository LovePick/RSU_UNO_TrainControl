...
#define IR_sensor0Pin D0 //SSC-AL
#define IR_sensor1Pin D1 //SB14-AL
#define IR_sensor2Pin D2 //STB05
#define IR_sensor3Pin D3 //STB06
#define IR_sensor4Pin D5 //SB14-BL
#define IR_sensor5Pin D6 //SSC-BL
#define IR_sensor6Pin D7
#define IR_sensor7Pin D8
#define IR_sensor8Pin D9
#define IR_sensor9Pin D10
...
struct DirectionInterface directionList[10];

struct StationAndCarInterface stationList[6];
...
void setupDirectionList(){
  directionList[0].target1 = "B11-C";
  directionList[0].target2 = "SC-A";

  directionList[1].target1 = "D01";
  directionList[1].target2 = "B02-B";

  directionList[2].target1 = "B11-D";
  directionList[2].target2 = "SC-B";

  directionList[3].target1 = "TB04";
  directionList[3].target2 = "B15-B";

  directionList[4].target1 = "SC-A";
  directionList[4].target2 = "B14-A";

  directionList[5].target1 = "SC-B";
  directionList[5].target2 = "B14-B";

  directionList[6].target1 = "B14-A";
  directionList[6].target2 = "TB05";

  directionList[7].target1 = "B14-A";
  directionList[7].target2 = "TB06";

  directionList[8].target1 = "B14-B";
  directionList[8].target2 = "TB05";

  directionList[9].target1 = "B14-B";
  directionList[9].target2 = "TB06";
...
void setupStationList(){
  stationList[0].stationID = "SC-A";
  stationList[0].carID = "";
  stationList[0].lastCarID = "";

  stationList[1].stationID = "SC-B";
  stationList[1].carID = "";
  stationList[1].lastCarID = "";

  stationList[2].stationID = "B14-A";
  stationList[2].carID = "";
  stationList[2].lastCarID = "";

  stationList[3].stationID = "B14-B";
  stationList[3].carID = "";
  stationList[3].lastCarID = "";

  stationList[4].stationID = "TB05";
  stationList[4].carID = "";
  stationList[4].lastCarID = "";

  stationList[5].stationID = "TB06";
  stationList[5].carID = "";
...
void registerControl(){
  webSocket.emit("registerControl", "{\"name\":\"CT06_01\"}");
}
//----
