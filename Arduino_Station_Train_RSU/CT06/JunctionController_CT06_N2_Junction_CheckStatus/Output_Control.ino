...
//if(index != lastJunction){
  switch(index){
    ...
    case 4:
    //Do something
    Serial.print ("SC-A->B14-A");

    break;
    case 5:
    //Do something
    Serial.print ("SC-B->B14-B");  
    
    break;
    case 6:
    //Do something
    Serial.print ("B14-A->TB05");  
    //Point 14A Normal P1
      P1Normal();
    //Point 14B Normal P2
      P2Normal();
    ...
    case 7:
    //Do something
    Serial.print ("B14-A->TB06");
    //Point 14A Reverse P1
      P1Reverse();
    //Point 14B Reverse P2
      P2Reverse();      
    
    break;
    case 8:
    //Do something
    Serial.print ("B14-B->TB05");  
    //Point 14A Reverse P1
      P1Reverse();
    //Point 14B Reverse P2
      P2Reverse();      
